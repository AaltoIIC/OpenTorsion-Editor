...
<div class="main-button-cont {isDopdownOpen ? "open" : ""}"
...
<button
    ...
    on:click={() => {isDopdownOpen = !isDopdownOpen}}>
    {#if icon}
...
<div class="main-dropdown">
    {#each options as option, index}
        <button on:click={() => {onClick(option); isDopdownOpen = false;}}>
